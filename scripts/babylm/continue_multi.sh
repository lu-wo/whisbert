...
python src/train.py experiment=babylm/whisbert_multi ckpt_path=/om/user/luwo/projects/MIT_prosody/logs/train/runs/2023-08-17/19-48-02/checkpoints/last.ckpt
