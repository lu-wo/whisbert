...
class PauseRegressionDataModule(LightningDataModule):
    """
    ...
    def __init__(
        ...
        model_name: str = None,
        pause_mode: str = "after",  # TODO currently not used
    ...
    def prepare_dataset(self, file_name):
        ...
        if os.path.exists(data_cache_path) and data_id in os.listdir(data_cache_path):
            ...
            pauses = extractor.get_all_pause_after()

            # Save the data to cache
            data = {"texts": texts, "pauses": pauses}
