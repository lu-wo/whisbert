...
class ProminenceClassificationDataModule(LightningDataModule):
    """
    ...
    def prepare_dataset(self, file_name):
        extractor = HelsinkiProminenceExtractor(self.dataset_path, file_name)
        texts = extractor.get_all_texts()
        prominences = extractor.get_all_discrete_prominence(
            classes=self.hparams.nb_classes
        )
        ...
        return texts, prominences, dataset
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        self.val_texts, self.val_prominences, self.val_dataset = self.prepare_dataset(
        ...
        (
            ...
            self.test_dataset,
        ) = self.prepare_dataset(self.hparams.test_file)
